...
def main() -> int:
    ...
    scheduled_task_name = args.scheduled_task_name or (
        "News-Grasp Production" if args.mode == "runner" else "News-Grasp Bootstrap"
    )
    extra = [
        "-Start", "-UseProductionRuntime", "-ScheduledTaskName", scheduled_task_name,
